...
- MS office: 수식입력 누르시거나 (텍스트 입력할 공간에 커서 노르고 ```Alt```+N+E+I) 
    - Selection: 역슬래쉬 sigma 치고 스페이스 한 번 ㅋㅋㅋ
    - Projection: 역슬래쉬 Pi 치고 스페이스 한 번
    - Cartesian Product: 역슬래쉬 times 치고 스페이스 한 번
    - Join: 역슬래쉬 bowtie 치고 스페이스 한 번
    - theta: 역슬래쉬 theta 치고 스페이스 한 번
    - 아랫첨자: 언더바 (쉬프트 0 오른쪽에 있는거 ㅋㅋ)치고 스페이스 한 번하면 아랫첨자 공간 생깁니다.
    - 윗첨자: hat (쉬프트 6)치고 스페이스 한 번하면 윗첨자 공간 생깁니다.
